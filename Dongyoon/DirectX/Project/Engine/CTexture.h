...
{
private:
    ScratchImage                    m_Image; // 텍스쳐 로딩 및 시스템 메모리 관리
    ...
    ComPtr<ID3D11UnorderedAccessView>   m_UAV;   //GPGPU(General Purpose GPU) - CompiteShaderr, 읽기 쓰기 동시가능, (Unordered Register(u) 에 바인딩 가능)
