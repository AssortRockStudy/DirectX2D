...
void CMaterial::SetScalarParam(SCALAR_PARAM _ParamType, const T& _Value)
{
    ...
    case SCALAR_PARAM::INT_3:
        ...
        m_Const.iArr[(UINT)_ParamType] = _Value;
        break;
    ...
    case SCALAR_PARAM::FLOAT_3:
        m_Const.iArr[UINT(_ParamType) - UINT(SCALAR_PARAM::FLOAT_0)] = _Value;
        break;
    ...
    case SCALAR_PARAM::VEC2_3:
        m_Const.iArr[UINT(_ParamType) - UINT(SCALAR_PARAM::VEC2_0)] = _Value;
        break;
    ...
    case SCALAR_PARAM::VEC4_3:
        m_Const.iArr[UINT(_ParamType) - UINT(SCALAR_PARAM::VEC4_0)] = _Value;
        break;
    ...
    case SCALAR_PARAM::MAT_3:
        m_Const.iArr[UINT(_ParamType) - UINT(SCALAR_PARAM::MAT_0)] = _Value;
        break;
    }
}